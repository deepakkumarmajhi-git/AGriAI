      ...
      <section className="relative z-10 mx-auto grid max-w-6xl items-center gap-10 px-5 pb-14 pt-6 md:grid-cols-2">
        ...
        <div>
          <div className="inline-flex items-center gap-2 rounded-full bg-white/5 px-3 py-1 text-xs text-white/70 ring-1 ring-white/10">
            ...
            Stored in MongoDB • MVP Session
          </div>

          <h1 className="mt-4 text-4xl font-semibold leading-tight md:text-5xl">
            Build smarter farming with{" "}
          ...
          <p className="mt-4 max-w-lg text-sm text-white/70">
            Create your account to access dashboard insights, irrigation planning, leaf
            scanning, and scan history — all in one modern interface.
          </p>

          <div className="mt-7 grid max-w-lg grid-cols-2 gap-3">
            <MiniCard title="7-day forecast" sub="Cached fallback" />
            <MiniCard title="Scan leaf" sub="AI prediction UI" />
            <MiniCard title="Irrigation plan" sub="Rules-based MVP" />
            <MiniCard title="AI assistant" sub="Multilingual chat" />
          </div>
        </div>
        ...
        <div className="relative">
          <div className="rounded-3xl bg-white/5 p-6 ring-1 ring-white/10 backdrop-blur-xl">
            <div className="flex items-start justify-between">
              <div>
                ...
                <p className="mt-1 text-sm text-white/60">
                  Create your account (stored in MongoDB).
                </p>
              </div>
            ...
            <p className="mt-5 text-sm text-white/70">
              ...
              <Link href="/auth/login" className="font-semibold text-emerald-200 hover:text-emerald-100">
                Login
              </Link>
            </p>

            <div className="mt-4 rounded-2xl bg-white/5 px-4 py-3 text-xs text-white/60 ring-1 ring-white/10">
              If you get “Email already exists”, try logging in.
            </div>
          </div>
  ...
  return (
    <div className="mt-3">
      ...
      <div className="mt-2 h-2 w-full rounded-full bg-white/10">
        <div
          className="h-2 rounded-full bg-emerald-400 shadow-[0_0_14px_rgba(52,211,153,0.6)] transition-all"
